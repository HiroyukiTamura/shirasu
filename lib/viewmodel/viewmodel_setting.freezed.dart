...
// ignore: unused_element
  StateSuccess success(Viewer dashboardModel) {
    return StateSuccess(
      dashboardModel,
    );
  }
...
mixin _$SettingModelState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result success(Viewer dashboardModel),
    @required Result error(),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result preInitialized(),
    Result success(Viewer dashboardModel),
    Result error(),
...
abstract class $StateSuccessCopyWith<$Res> {
  ...
  $Res call({Viewer dashboardModel});

  $ViewerCopyWith<$Res> get dashboardModel;
}
...
class _$StateSuccessCopyWithImpl<$Res>
  ...
  $ViewerCopyWith<$Res> get dashboardModel {
    ...
    return $ViewerCopyWith<$Res>(_value.dashboardModel, (value) {
...
class _$StateSuccess implements StateSuccess {
  ...
  @override
  final Viewer dashboardModel;

  @override
  String toString() {
    return 'SettingModelState.success(dashboardModel: $dashboardModel)';
  }
...
abstract class StateSuccess implements SettingModelState {
  const factory StateSuccess(Viewer dashboardModel) = _$StateSuccess;

  Viewer get dashboardModel;
  $StateSuccessCopyWith<StateSuccess> get copyWith;
}
