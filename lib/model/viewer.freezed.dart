...
abstract class _ViewerUser implements ViewerUser {
  const factory _ViewerUser(
      ...
      @required InvoiceHistory invoiceHistory,
      @required WatchHistories watchHistories,
      @required List<SubscribedChannel> subscribedChannels}) = _$_ViewerUser;
...
abstract class _Channel implements Channel {
  const factory _Channel(
      ...
      @required String name,
      dynamic icon,
      @required @JsonKey(name: '__typename') dynamic typename}) = _$_Channel;
...
abstract class _Program implements Program {
  const factory _Program(
      ...
      @required String detail,
      @required DateTime broadcastAt,
      @required @JsonKey(name: '__typename') dynamic typename}) = _$_Program;
